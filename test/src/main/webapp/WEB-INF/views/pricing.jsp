			...
			<main>
				...
				<div class="container-xl px-4 text-center">
					<div class="text-center my-10 text-xl">
						<div><span class="fw-700" style="color:rgb(159, 218, 37)">아오팜</span><span style="font-size: 2.2rem">의 더 많은 서비스를 이용하세요</span></div>
					</div>
					...
					<div class="pricing-detailed">
						<div class="row align-items-center g-0">
							...
							<div class="col-lg-6 z-1 mb-4 mb-lg-0">
								<div class="card text-center border-0 m-4" style="background-color: #B8E6E1">
									
									<div class="card-body p-5">
									<h5 class="text-primary mb-0">Paid</h5>
							...
							<div class="col-lg-6 z-1 mb-4 mb-lg-0">
								<div class="card text-center border-0 m-4" style="background-color: #FFCD4A">
									
									<div class="card-body p-5">
									<h5 class="text-primary mb-0">Premium</h5>
