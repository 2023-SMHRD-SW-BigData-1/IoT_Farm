				...
				<div class="sidenav-menu">
					<div class="nav accordion" id="accordionSidenav">
						...
						<div class="sidenav-menu-heading nav-menu">
							...
							%>
							<a style="text-decoration: none" class="nav-plus badge bg-primary-soft text-primary" href="#!" tabindex="0" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="right"
							 data-bs-content="더 많은 IoT를 사용 가능을 위해 버전 업그레이드가 필요합니다!" title="IoT의 최대개수에 도달했습니다.">+</a>
							<%
							}
							%>
						</div>
