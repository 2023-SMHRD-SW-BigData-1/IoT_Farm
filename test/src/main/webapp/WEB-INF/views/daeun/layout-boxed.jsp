			...
			<nav class="sidenav shadow-right sidenav-light">
				<div class="sidenav-menu">
					<div class="nav accordion" id="accordionSidenav">
						...
						</a> <a class="navbar-brand mx-xl-4 pe-2 ps-2" href="/bigdata/main">
						...
						<a class="nav-link collapsed" href="javascript:void(0);"
							data-bs-toggle="collapse" data-bs-target="#cloudService"
							aria-expanded="false" aria-controls="cloudService">
							<div class="nav-link-icon">
						...
						<div class="collapse" id="cloudService"
							data-bs-parent="#accordionSidenav">
							<nav class="sidenav-menu-nested nav accordion"
								id="cloudServiceMenu">
								<a class="nav-link" href="account-profile.html">IoT 세팅하기</a>
								<a class="nav-link" href="account-billing.html">IoT 등록하기</a>
								<a class="nav-link" href="account-security.html">센서 등록하기</a> 
								<a
									class="nav-link collapsed" href="javascript:void(0);"
									data-bs-toggle="collapse"
									data-bs-target="#pagesCollapseAccount" aria-expanded="false"
									aria-controls="pagesCollapseAccount"> 센서데이터 송신하기
									<div class="sidenav-collapse-arrow">
										<i class="fas fa-angle-down"></i>
									</div>
								</a> 
						...
						<div class="collapse" id="collapsePages"
							...
							<nav class="sidenav-menu-nested nav accordion"
								...
								<a class="nav-link collapsed" href="javascript:void(0);"
									data-bs-toggle="collapse" data-bs-target="#dashBoardService"
									aria-expanded="false" aria-controls="dashBoardService">
									<div class="nav-link-icon">
										<i data-feather="grid"></i>
									</div> 대시보드 구성하기
									<div class="sidenav-collapse-arrow">
								...
								<div class="collapse" id="collapseApps"
									...
									<nav class="sidenav-menu-nested nav accordion"
										...
										<a class="nav-link collapsed" href="javascript:void(0);"
											...
											aria-expanded="false"
											aria-controls="appsCollapseUserManagement"> User
											Management
											<div class="sidenav-collapse-arrow">
												<i class="fas fa-angle-down"></i>
											</div>
			...
			<main>
				...
				<div class="container-xl px-4">
					<div class="card mt-n10">
						...
						<div class="card-body">This is an example of a page with the
							default boxed layout. We've expanded Bootstrap by adding a new
							xxl breakpoint. As the screen width gets larger, the container
							element will set a max width to the content. The boxed layout
							uses the max width container element on the page header and in
							the main page content in this example.</div>
					</div>
				</div>
			</main>
		</div>
