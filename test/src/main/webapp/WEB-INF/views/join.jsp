									...
									<form action="/join" method="get">
										...
										<div class="mb-3">
											<label class="small mb-1" for="Email">이메일</label> <input
												...
												<div class="d-flex align-items-center justify-content-right mt-10px">
											<button class="btn btn-primary h-10">인증번호 전송</button>
											</div>
											<br>
											<br> <input class="emailcheck" id="inputEmail"
												type="text"></input>
											<button class="btn btn-primary h-10">인증번호 확인</button>
										</div>
										<!-- Form Group (join box)-->
										<div
